...
Util.buildRegistrationView = async function(){
    ...
    registration_view+='<input type="text" name="account_firstname" required value="">'
    registration_view+='<label for="last_name">Last name</label>'
    registration_view+='<input type="text" name="account_lastname" required value="">'
    registration_view+='<label for="email">Email address</label>'
    registration_view+='<input type="email" name="account_email" required placeholder="Enter a valid email address" value= "" >'
...
Util.buildAddClassificationView = async function(){
          ...
          adclass_view+='<input type="text" name="classification_name"  value="" required pattern="[A-Za-z]+"><br/>'
